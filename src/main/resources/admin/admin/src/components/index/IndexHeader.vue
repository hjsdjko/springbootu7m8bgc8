<template>
	<div class="navbar">
		...
		<!-- 时间 -->
		<div :style='{"padding":"0 4px 0 30px","fontSize":"inherit","lineHeight":"44px","color":"#fff","background":"url(http://codegen.caihongy.cn/20231003/60f81a8d54fe44f7848187aba48f4c44.png) no-repeat left center / 24px","order":"2"}'>{{times}}</div>
		<!-- 系统通知-1 -->
		<el-button class="notice" @click="dialogVisible = true" :style='{"border":"0","cursor":"pointer","padding":"0 12px","margin":"0","color":"#fff","borderRadius":"4px","background":"none","width":"auto","fontSize":"14px","height":"40px","order":"4"}' type="success">
