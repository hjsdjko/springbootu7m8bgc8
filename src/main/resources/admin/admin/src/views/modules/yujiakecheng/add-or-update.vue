	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="上课时间" prop="shangkeshijian">
					<el-select :disabled="ro.shangkeshijian" v-model="ruleForm.shangkeshijian" placeholder="请选择上课时间" multiple filterable>
						<el-option
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="可预约人数" prop="keyuyuerenshu">
					<el-input  v-model.number="ruleForm.keyuyuerenshu" placeholder="可预约人数" clearable  :readonly="ro.keyuyuerenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="可预约人数" prop="keyuyuerenshu">
					<el-input v-model="ruleForm.keyuyuerenshu" placeholder="可预约人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="课程地点" prop="kechengdidian">
					<el-input  v-model="ruleForm.kechengdidian" placeholder="课程地点" clearable  :readonly="ro.kechengdidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="课程地点" prop="kechengdidian">
					<el-input v-model="ruleForm.kechengdidian" placeholder="课程地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="目标" prop="mubiao">
					<el-input  v-model="ruleForm.mubiao" placeholder="目标" clearable  :readonly="ro.mubiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="目标" prop="mubiao">
					<el-input v-model="ruleForm.mubiao" placeholder="目标" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="部位" prop="buwei">
					<el-input  v-model="ruleForm.buwei" placeholder="部位" clearable  :readonly="ro.buwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="部位" prop="buwei">
					<el-input v-model="ruleForm.buwei" placeholder="部位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="强度" prop="qiangdu">
					<el-select :disabled="ro.qiangdu" v-model="ruleForm.qiangdu" placeholder="请选择强度" >
						<el-option
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="强度" prop="qiangdu">
					<el-input v-model="ruleForm.qiangdu"
						placeholder="强度" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info'&& !ro.kechengduanpian" label="课程短片" prop="kechengduanpian">
					<file-upload
						tip="点击上传课程短片"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.kechengduanpian" label="课程短片" prop="kechengduanpian">
					<el-button :style='{"border":"0px solid #000","cursor":"pointer","padding":"0 20px","margin":"0 20px 0 0","color":"inherit","textAlign":"left","minWidth":"350px","outline":"none","borderRadius":"0px","background":"#fff","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="text" size="small" @click="download($base.url+ruleForm.kechengduanpian)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="!ruleForm.kechengduanpian" label="课程短片" prop="kechengduanpian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="注意事项" prop="zhuyishixiang">
					<editor 
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.zhuyishixiang" label="注意事项" prop="zhuyishixiang">
                    <span :style='{"padding":"0 20px","color":"inherit","background":"#fff","display":"inline-block","width":"80%","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.zhuyishixiang"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zhuyishixiang = this.ruleForm.zhuyishixiang.replace(reg,'../../../springbootu7m8bgc8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.kechengduanpian!=null) {
		this.ruleForm.kechengduanpian = this.ruleForm.kechengduanpian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yujiakecheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yujiakechengCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    kechengduanpianUploadChange(fileUrls) {
	    this.ruleForm.kechengduanpian = fileUrls;
    },
  }
};
</script>
