	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="报名人数" prop="keyuyuerenshu">
					<el-input  v-model.number="ruleForm.keyuyuerenshu" placeholder="报名人数" clearable  :readonly="ro.keyuyuerenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="报名人数" prop="keyuyuerenshu">
					<el-input v-model="ruleForm.keyuyuerenshu" placeholder="报名人数" readonly></el-input>
				</el-form-item>
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
		  if(!this.ruleForm.keyuyuerenshu){
			  this.$message.error("报名人数不能为空");
			  return
		  }
	      objcross.keyuyuerenshu = objcross.keyuyuerenshu - this.ruleForm.keyuyuerenshu
	      if(objcross.keyuyuerenshu<0){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yuyuechaxun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuyuechaxunCrossAddOrUpdateFlag = false;
						 this.parent.search();
