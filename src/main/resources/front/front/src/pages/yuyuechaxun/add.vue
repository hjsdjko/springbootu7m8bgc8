...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="报名人数" prop="keyuyuerenshu">
            <el-input  v-model.number="ruleForm.keyuyuerenshu" 
                placeholder="报名人数" clearable :readonly=" false  ||ro.keyuyuerenshu"></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`yuyuechaxun/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
      ...
      onSubmit() {
        ...
        obj.keyuyuerenshu = obj.keyuyuerenshu - this.ruleForm.keyuyuerenshu
        if(obj.keyuyuerenshu<0){
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('yuyuechaxun/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          obj.keyuyuerenshu = parseFloat(obj.keyuyuerenshu) - parseFloat(this.ruleForm.keyuyuerenshu)

                          this.$http.post(table+`/update`,obj).then(res => {});
                          this.$http.post(`yuyuechaxun/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
