    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="课程类型" prop="kechengleixing">
            <el-input  v-model="ruleForm.kechengleixing" 
                placeholder="课程类型" clearable :readonly=" false  ||ro.kechengleixing"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="上课时间" prop="shangkeshijian">
            <el-input  v-model="ruleForm.shangkeshijian" 
                placeholder="上课时间" clearable :readonly=" false  ||ro.shangkeshijian"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="上课备注" prop="shangkebeizhu">
            <el-input  v-model="ruleForm.shangkebeizhu" 
                placeholder="上课备注" clearable :readonly=" false  ||ro.shangkebeizhu"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="课程满意度" prop="kechengmanyidu">
            <el-select v-model="ruleForm.kechengmanyidu" placeholder="请选择课程满意度"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="教练评分" prop="jiaolianpingfen">
            <el-select v-model="ruleForm.jiaolianpingfen" placeholder="请选择教练评分"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="体验感" prop="tiyangan">
            <el-select v-model="ruleForm.tiyangan" placeholder="请选择体验感"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="课后评价" prop="kehoupingjia">
            <editor 
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`kehoupingjia/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('kehoupingjia/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post(`kehoupingjia/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
