...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="体重" prop="tizhong">
            <el-input  v-model="ruleForm.tizhong" 
                placeholder="体重" clearable :readonly=" false  ||ro.tizhong"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="身高" prop="shengao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="出生年月" prop="chushengnianyue">
              <el-date-picker
				  :disabled=" false  ||ro.chushengnianyue"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="从业年月" prop="congyenianyue">
            <el-input  v-model="ruleForm.congyenianyue" 
                placeholder="从业年月" clearable :readonly=" false  ||ro.congyenianyue"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="密码错误次数" prop="passwordwrongnum">
            <el-input  v-model.number="ruleForm.passwordwrongnum" 
                placeholder="密码错误次数" clearable :readonly=" false  ||ro.passwordwrongnum"></el-input>
          </el-form-item>
